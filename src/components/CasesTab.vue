...
.case-card{background:var(--glass-bg);border:1px solid var(--line);border-radius:12px;padding:11px;cursor:pointer;transition:.15s var(--spring);border-color:var(--glass-border);box-shadow:inset 0 1px 0 var(--glass-shine),0 4px 16px var(--glass-shadow);backdrop-filter:var(--glass-blur);-webkit-backdrop-filter:var(--glass-blur);}
...
.decl-table{background:var(--glass-bg);border:1px solid var(--line);border-radius:12px;overflow:hidden;border-color:var(--glass-border);box-shadow:inset 0 1px 0 var(--glass-shine),0 4px 16px var(--glass-shadow);backdrop-filter:var(--glass-blur);-webkit-backdrop-filter:var(--glass-blur);}
...
.ct-note{background:rgba(35,88,138,.06);border:1px solid rgba(35,88,138,.15);border-radius:12px;padding:14px;display:flex;flex-direction:column;gap:8px;}

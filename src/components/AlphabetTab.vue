...
.at-cell { border-right:1px solid rgba(176,120,40,.2); border-bottom:1px solid var(--line); padding:18px 10px 14px; background:var(--bg2); backdrop-filter:blur(4px); cursor:pointer; transition:all .15s; position:relative; text-align:center; }
...
.lv-letter-card { background:var(--bg2); backdrop-filter:blur(8px); border:2px solid rgba(140,28,28,.25); border-radius:20px; padding:36px 20px 28px; text-align:center; }
...
.lv-sound-block { background:var(--bg2); border:1px solid var(--line); border-radius:14px; padding:16px 20px; display:flex; align-items:center; gap:16px; }
...
.lv-word-card { background:var(--bg2); backdrop-filter:blur(6px); border:1px solid rgba(26,58,110,.2); border-radius:16px; padding:18px 20px; }
...
.lv-quiz { background:var(--bg2); border:1px solid var(--line); border-radius:16px; padding:18px; }
...
.lv-quiz-opt  { padding:16px; border:1.5px solid var(--line); border-radius:12px; background:var(--bg2); font-family:var(--m); font-size:16px; color:var(--ink); cursor:pointer; transition:.15s; text-align:center; }
...
.lv-learned-btn { flex:1; padding:16px; background:var(--bg2); border:2px solid var(--line); border-radius:14px; font-family:var(--d); font-size:16px; font-style:italic; color:var(--muted); cursor:pointer; transition:all .2s; }

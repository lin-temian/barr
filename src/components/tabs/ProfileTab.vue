...
.prof-avatar {
  ...
  font-family: var(--d); font-size: 24px; font-weight: 700; color: var(--bg);
...
.prof-lvl   { background: var(--red); color: var(--bg); font-family: var(--m); font-size: 11px; font-weight: 700; padding: 5px 12px; border-radius: 12px; }

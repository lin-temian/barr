...
.cc-bar { flex:1; height:5px; background:var(--glass-bg); border-radius:3px; border-color:var(--glass-border);box-shadow:inset 0 1px 0 var(--glass-shine),0 4px 16px var(--glass-shadow);}
